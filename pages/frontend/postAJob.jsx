...
export default function PostAJob() {
    ...
    const [formData, setFormData] = useState({ user: user?._id, title: "", salary: 0, email: user?.email, company: "", description: "", job_category: "", job_type: "", job_experience: "", job_vacancy: 0, job_deadline: "" });
    ...
    const { title, salary, email, company, description, job_category, job_type, job_experience, job_vacancy, job_deadline } = formData;
            ...
            <div className='w-full  py-20 flex items-center  justify-center flex-col'>
                ...
                <form onSubmit={handleSubmit} className="sm:w-1/2 w-full px-4 mx-4  h-full" >
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, job_vacancy: e.target.value })} inputMode='numeric' id='jobva' className='w-full py-2 px-3 mb-2 border border-indigo-600 rounded' placeholder='Enter Number  of Vacancies' />
                        {
